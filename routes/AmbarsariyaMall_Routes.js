...
router.get("/sell/near-by-areas/:searched_value", eshopController.get_near_by_area);
router.get(
...
router.get("/sell/selected-co-helper/:id", coHelperController.get_requestedCoHelper);
