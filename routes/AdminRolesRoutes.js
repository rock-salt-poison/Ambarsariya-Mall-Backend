...
router.get('/managers/:department_name', rolesController.get_managers_by_department);
router.get('/manager-token/:id', rolesController.get_manager_token_by_id);
router.get('/staff/:token', rolesController.get_staff);
router.get('/sales-staff/:token', rolesController.get_sales_staff);
router.get('/staff-members/:id', rolesController.get_staff_members_by_manager_id);
router.get('/sales-staff-members/:id', rolesController.get_sales_staff_members_by_manager_id);
router.get('/staff-with-type/:token/:staff_type', rolesController.get_staff_with_type);
router.get('/sales-staff-with-type/:token/:staff_type', rolesController.get_sales_staff_with_type);
router.get('/staff-confirm-summaries', rolesController.get_staff_confirm_summaries);
router.get('/staff-tasks/:token', rolesController.get_staff_tasks);
router.get('/sales-staff-tasks/:token', rolesController.get_sales_staff_tasks);
...
router.get('/marketing-staff-report-details/:task_report_id', rolesController.get_marketing_staff_report_details_by_task_report_id);
router.get('/all-reports-by-staff-and-type', rolesController.get_all_reports_by_staff_and_type);
...
router.post('/create-sales-staff_task', rolesController.create_sales_staff_task);
...
router.put('/create-sales-staff', rolesController.create_sales_staff);
